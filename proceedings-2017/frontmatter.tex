...
%%% EDIT TITLE: %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            pdftitle={Third Internation Workshop for Computational Linguistics
            of Uralic Languages},
            pdfauthor={Association for Computational Linguistics' SIG for
            Uralistics},
            %pdfsubject={...},
            %pdfkeywords={...}
...
\newcommand{\draftframe}[1][0]{
  \AddToShipoutPicture{
    ...
    %% for left margin = right margin = 25mm, A4
    \put(185,20){\line(0,1){271}}
    \multiput(15,172)(10,0){3}{\line(0,1){53}}
    \multiput(15,172)(5,0){5}{\line(0,1){46}}
    \multiput(15,172)(1,0){20}{\line(0,1){40}}
    \put(15,232){\makebox(0,0){-10}}
